...
var clientcorps = (salesmgr.ClientCorporation.length) ? salesmgr.ClientCorporation: [salesmgr.ClientCorporation];
...
buf.push("<span><strong>" + (jade.escape((jade_interp = action) == null ? '' : jade_interp)) + ":  </strong>" + (jade.escape((jade_interp = actcnt) == null ? '' : jade_interp)) + "</span><br/>");
    }
...
buf.push("<span><strong>" + (jade.escape((jade_interp = activity.name.replace('_Note', ' Notes')) == null ? '' : jade_interp)) + ":  </strong>" + (jade.escape((jade_interp = activity.cnt) == null ? '' : jade_interp)) + "</span><br/>");
    }
...
buf.push("</center></td></tr></table><table class=\"container\"><tr><td align=\"center\" class=\"center\"><center><table class=\"row header\"><tr><td class=\"wrapper last\"><table class=\"twelve columns\"><tr><td style=\"padding-bottom:25px; padding-top:15px; text-align:center; color:#fff\">& copy; 2014 314e Corporation. All rights reserved.</td><td class=\"expander\"></td></tr></table></td></tr></table></center></td></tr></table></center></td></tr></table></body></html>");}.call(this,"rundate" in locals_for_with?locals_for_with.rundate:typeof rundate!=="undefined"?rundate:undefined,"EmailData" in locals_for_with?locals_for_with.EmailData:typeof EmailData!=="undefined"?EmailData:undefined,"Array" in locals_for_with?locals_for_with.Array:typeof Array!=="undefined"?Array:undefined));;return buf.join("");
}