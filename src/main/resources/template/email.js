...
buf.push("<span" + (jade.attr("style", "" + (lstyle) + "", true, false)) + "><strong>" + (jade.escape((jade_interp = ai.replace('_Note', ' Notes')) == null ? '' : jade_interp)) + ":  </strong>" + (jade.escape((jade_interp = jactivity) == null ? '' : jade_interp)) + "</span><br/>");
    }
...
buf.push("</td><td class=\"expander\"></td></tr></table></td><td class=\"wrapper last\"><table style=\"background:#fff\" class=\"five columns\"><tr><td style=\"padding-top:10px\" class=\"last right-text-pad\"><h6 style=\"color:#636567; padding-bottom:10px\">All Activity</h6>");
...
var lstyle = ai.indexOf('_Note')>-1 ? '' : 'color:#48c3b1;'
buf.push("<span" + (jade.attr("style", "" + (lstyle) + "", true, false)) + "><strong>" + (jade.escape((jade_interp = ai.replace('_Note', ' Notes')) == null ? '' : jade_interp)) + ":  </strong>" + (jade.escape((jade_interp = activity) == null ? '' : jade_interp)) + "</span><br/>");
    }
